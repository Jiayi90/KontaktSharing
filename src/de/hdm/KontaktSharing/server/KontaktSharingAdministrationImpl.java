...
public class KontaktSharingAdministrationImpl extends RemoteServiceServlet implements KontaktSharingAdministration {
	...
	/**
	 * Referenz auf das zugehÃ¶rige Nutzer-Objekt.
	 */
	...
	public void init() throws IllegalArgumentException {
		...
		/**
		 * Die KontaktsharingAdministration muss einen vollstÃ¤ndigen Satz von Mappern
	...
	public Eigenschaftauspraegung createEigenschaftauspraegung(String text, int zahl, Date datum)
		...
		/**
		 * Setzen eines vorlÃ¤ufigen Eigenschaftauspraegung-ID.
		 */
	...
	public Eigenschaft createEigenschaft(String bezeichnung, String typ) throws IllegalArgumentException, SQLException {
		...
		/**
		 * Setzen eines vorlÃ¤ufigen Eigenschaft-ID.
		 */
...
//		this.nutzer = n;
	...
	/**
	 * Kontaktliste anlegen für Nutzer
	 */
	@Override
	...
	/**
	 * Alle Kontaktlsten mit User für Nutzer auslesen
	 */
	@Override
	...
	/**
	 * ausgabe der geteilten Kontaktlisten für den User
	 */
	@Override
