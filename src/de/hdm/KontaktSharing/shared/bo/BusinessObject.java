...
public abstract class BusinessObject implements Serializable {
	 ...
	 * kann selbstverständlich in Subklassen überschrieben werden.
	 */
	@Override
	 ...
	 * auf eine identische ID beschränkt.
	 * </p>
	 * <p>
	 * <b>ACHTUNG:</b> Die inhaltliche Gleichheit nicht mit dem Vergleich der
	 * <em>Identität</em> eines Objekts mit einem anderen verwechseln!!! Dies würde
	 * durch den Operator <code>==</code> bestimmt. Bei Unklarheit hierzu können Sie
	 * nocheinmal in die Definition des Sprachkerns von Java schauen. Die Methode
	 * <code>equals(...)</code> ist für jeden Referenzdatentyp definiert, da sie
	 ...
	 * Java-internen Objekt-ID der verglichenen Objekte beschränkt. In unseren
	 * eigenen Klassen können wir diese Methode überschreiben und ihr mehr
	...
	public boolean equals(Object o) {
		...
		/*
		 * Wenn bislang keine Gleichheit bestimmt werden konnte, dann müssen schließlich
		 * false zurückgeben.
		 */
		return false;
	}
	 ...
	 * (z.B. in einer Hashtable) zu identifizieren. Erst danach würde mit
	 * <code>equals</code> festgestellt, ob es sich tatsächlich um das gesuchte
	 * Objekt handelt.
	 */
	@Override
	public int hashCode() {
